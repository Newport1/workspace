...
fourthButton.addActionListener(this);
	...
	private JButton createButton(String dollarAmount) {
		...
		JButton JComponents = new JButton();
		// Set the text of the button to the dollarAmount
		JComponents.setText(dollarAmount);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton) {
			askQuestion("Which is not a JComponent? JPane JDialog, JWindow,",
					"JPane", 100);
			firstButton.setText("");
		}
		...
		if (buttonPressed == secondButton) {
			askQuestion("How do you make a window pop up", "JOptionPane", 200);
		}
	...
	if (buttonPressed == thirdButton) {
		askQuestion("Which is not a primitive data type? Byte, String, Short", "String", 300);
	}
 ...
 thirdButton.setText("");
	...
	if (buttonPressed == fourthButton) {
		askQuestion("Statements are roughly equivalent to sentences in natural languages, but instead of ending with a period, a statement ends with a ___.", ";", 400);
	}
...
fourthButton.setText("");
	...
	private void askQuestion(String question, String correctAnswer,
		...
		if (a.equals(correctAnswer)) {
			...
			score = score - prizeMoney;
			JOptionPane.showMessageDialog(null, "The right answer was"
					+ correctAnswer);
			updateScore();
		}
